...
builder.Services.AddScoped<ISelfProfileService, SelfProfileService>();
builder.Services.AddScoped<AccountProfileValidator>();
builder.Services.AddScoped<AccountAvatarManager>();
builder.Services.AddScoped<IAnalyticsService, AnalyticsService>();
builder.Services.AddScoped<IContentService, ContentService>();
builder.Services.AddScoped<INpcLookupService, NpcLookupService>();
builder.Services.AddScoped<IModBootupService, ModBootupService>();
builder.Services.AddScoped<IModConfigService, ModConfigService>();
builder.Services.AddSingleton<ClientAddressHasher>();
...
builder.Services.AddScoped<ILineReportService, LineReportService>();
...
builder.Services.AddScoped<IModConfigRepository, ModConfigRepository>();
