...
PHP website for the Voices of Wynn project. This app uses a custom MVC framework: routes are defined in `routes.ini`, controllers live in `Controllers/`, models live in `Models/`, and views are `.phtml` files in `Views/`.
